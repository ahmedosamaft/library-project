...
let books = [
  {
    ...
    cover_image: 'https://unsplash.it/667/800?book_id=1',
  },
  {
    id: 2,
    title: '1984',
    ...
    cover_image: 'https://unsplash.it/667/800?book_id=2',
  },
  {
    id: 3,
    ...
    cover_image: 'https://unsplash.it/667/800?book_id=3',
  },
  {
    id: 4,
    ...
    cover_image: 'https://unsplash.it/667/800?book_id=4',
  },
  {
    id: 5,
    title: 'Moby-Dick',
    ...
    cover_image: 'https://unsplash.it/667/800?book_id=5',
  },
  {
    id: 6,
    ...
    cover_image: 'https://unsplash.it/667/800?book_id=6',
  },
  {
    id: 7,
    ...
    cover_image: 'https://unsplash.it/667/800?book_id=7',
  },
  {
    id: 8,
    title: 'The Hobbit',
    ...
    cover_image: 'https://unsplash.it/667/800?book_id=8',
  },
  {
    id: 9,
    ...
    cover_image: 'https://unsplash.it/667/800?book_id=9',
  },
  {
    id: 10,
    title: 'War and Peace',
    ...
    cover_image: 'https://unsplash.it/667/800?book_id=10',
  },
  {
    id: 11,
    title: 'The Odyssey',
    ...
    cover_image: 'https://unsplash.it/667/800?book_id=11',
  },
  {
    id: 12,
    ...
    cover_image: 'https://unsplash.it/667/800?book_id=12',
  },
  {
    id: 13,
    ...
    cover_image: 'https://unsplash.it/667/800?book_id=13',
  },
  {
    id: 14,
    ...
    cover_image: 'https://unsplash.it/667/800?book_id=14',
  },
  {
    id: 15,
    ...
    cover_image: 'https://unsplash.it/667/800?book_id=15',
  },
  {
    id: 16,
    ...
    cover_image: 'https://unsplash.it/667/800?book_id=16',
  },
  {
    id: 17,
    ...
    cover_image: 'https://unsplash.it/667/800?book_id=17',
  },
  {
    id: 18,
    title: 'Anna Karenina',
    ...
    cover_image: 'https://unsplash.it/667/800?book_id=18',
  },
  {
    id: 19,
    title: 'The Alchemist',
    ...
    cover_image: 'https://unsplash.it/667/800?book_id=19',
  },
  {
    id: 20,
...
app.get('/books', (req, res) => {
  const { title, author, category, all } = req.query;
  ...
  const filteredBooks = books.filter((book) => {
    ...
    if (category && !book.genre.includes(category)) {
      return false;
    }
    return true;
  });
  ...
  if (!isNaN(limit) && !isNaN(page)) {
    ...
    return res.json(filteredBooks.slice(startIndex, endIndex));
  }
...
app.post('/books', (req, res) => {
  ...
  const newBook = {
    ...
    genre: [category],
    description,
    cover_image: `https://unsplash.it/667/800?book_id=${id}`,
  };
...
// Dummy login and register endpoints
